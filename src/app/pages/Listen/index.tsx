...
const Listen: React.FC = function() {
  ...
  return (
    <div className={style.listenWrapper}>
      <h1 className = {style.title}>Test Temperature real time display</h1>
      <Chart scale = {scale} padding='auto' autoFit height={320} width={800} data={data} >
      ...
      <div></div>
      <Button className={style.btn} type='primary' onClick={ () => { history.push('/') }}>Back Home</Button>
    </div>
  );
}
